...
class MyDataset(object):
    def __init__(self, modality, data_partition, data_dir, label_fp, annonation_direc=None, preprocessing_func=None,
                 data_suffix='.npz', use_boundary=False):
    ...
    def __getitem__(self, idx):
        ...
        if self.use_boundary:
            boundary = self._get_boundary(self.list[idx][0], data)
